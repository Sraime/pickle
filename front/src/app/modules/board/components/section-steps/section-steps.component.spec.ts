...
mockAssemblyService.getAssembledCodeblock.mockReturnValue(null);
...
describe("SectionSetpsComponent", () => {
  ...
  it("should initialize steps whith stored step by the assembly", () => {
    ...
    mockAssemblyService.getAssembledCodeblock.mockReturnValue(mockedScenario);
    component.ngOnInit();
    expect(mockAssemblyService.getAssembledCodeblock).toHaveBeenCalledWith(
      "xxx"
    );
  ...
  it("should have a title", async(() => {
    ...
    fixture.whenStable().then(() => {
      fixture.detectChanges();
      const title = fixture.debugElement.query(By.css(".section-steps-title"))
        .nativeElement;
  ...
  it("should have a step list", async(() => {
    const list = fixture.debugElement.query(By.css(".section-steps-list"))
      .nativeElement;
  ...
  it("should display registered steps", async(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      const steps = fixture.debugElement.queryAll(
        By.css(".section-steps-list .section-step")
      );
