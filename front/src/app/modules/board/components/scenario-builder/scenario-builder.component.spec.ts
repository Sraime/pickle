  ...
  describe('scenario name', () => {
    ...
    it('should have the name displayed', async(() => {
      ...
      fixture.whenStable().then(() => {
        fixture.detectChanges();
        const scenarioName = fixture.debugElement.query(By.css(NAME_SELECTOR));
    ...
    describe('edit mode', () => {
      const EDIT_INPUT_SELECTOR = SCENARIO_HEADER_SELECTOR 
        + ' input.input-edit-scenario-name'; 
      const EDIT_BTN_SELECTOR = SCENARIO_HEADER_SELECTOR 
        + ' button.btn-save-scenario-name'; 
